...
class SettingWebsite extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            ...
            'upload_login' => 'image|mimes:png,jpeg,jpg|max:2048|dimensions:width=450,height=450',
            'upload_dashboard' => 'image|mimes:png,jpeg,jpg|max:2048|dimensions:min-width=220,min-height=50',
            'upload_favicon' => 'image|mimes:png,jpeg,jpg|max:2048|dimensions:width=180,height=180',
            'upload_navbar' => 'image|mimes:png,jpeg,jpg|max:2048|dimensions:min-width=450,min-height=180',
            'upload_footer' => 'image|mimes:png,jpeg,jpg|max:2048|dimensions:min-width=450,min-height=180',
