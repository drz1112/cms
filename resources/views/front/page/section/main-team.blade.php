              ...
              <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="team-member">
                  <div class="member-img">
                    ...
                    <div class="social">
                      <a href="{{ $item_team->team_twitter_link }}"><i class="bi bi-twitter-x"></i></a>
                      <a href="{{ $item_team->team_facebook_link }}"><i class="bi bi-facebook"></i></a>
                      <a href="{{ $item_team->team_ig_link }}"><i class="bi bi-instagram"></i></a>
                    </div>
                  </div>
