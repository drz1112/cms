<nav id="sidebar" class="sidebar js-sidebar">
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ Request::routeIs('kategorimenu.*') || Request::routeIs('settingswebsite.*') || Request::routeIs('settingsfront.*') ? 'active' : ''}}">
                ...
                <ul id="menudrop2" class="sidebar-dropdown list-unstyled collapse {{ Request::routeIs('kategorimenu.*') || Request::routeIs('settingswebsite.*') || Request::routeIs('settingsfront.*') || Request::routeIs('settinglayout.*') ? 'show' : ''}}" data-bs-parent="#sidebar"
                    style="">
                    ...
                    <li class="sidebar-item {{ Request::routeIs('settinglayout.*') ? 'active' : ''}}">
                        <a class="sidebar-link" href="{{route('settinglayout.index')}}">Layout (Front)</a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-item {{ Request::routeIs('settingsbannerfront.*') || Request::routeIs('settingboxs.*') || Request::routeIs('settingclients.*') || Request::routeIs('profilsingkat.*') || Request::routeIs('team.*')|| Request::routeIs('faq.*') ? 'active' : ''}}">
                ...
                <ul id="menudrop3" class="sidebar-dropdown list-unstyled collapse {{ Request::routeIs('settingsbannerfront.*') || Request::routeIs('settingboxs.*') || Request::routeIs('settingclients.*') || Request::routeIs('profilsingkat.*') || Request::routeIs('team.*') ? 'show' : ''}}" data-bs-parent="#sidebar"
                    ...
                    <li class="sidebar-item {{ Request::routeIs('settingclients.*') ? 'active' : ''}}">
                        <a class="sidebar-link" href="{{route('settingclients.index')}}">Clients</a>
                    </li>
                    ...
                    <li class="sidebar-item {{ Request::routeIs('faq.*') ? 'active' : ''}}">
                        <a class="sidebar-link" href="{{route('faq.index')}}">FAQ</a>
                    </li>
                </ul>
            </li>
            @endhasanyrole
