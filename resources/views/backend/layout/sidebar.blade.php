    ...
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ Request::routeIs('kategorimenu.*') || Request::routeIs('settingswebsite.*') ? 'active' : ''}}">
                ...
                <ul id="menudrop2" class="sidebar-dropdown list-unstyled collapse {{ Request::routeIs('kategorimenu.*') || Request::routeIs('settingswebsite.*') ? 'show' : ''}}" data-bs-parent="#sidebar"
                    style="">
