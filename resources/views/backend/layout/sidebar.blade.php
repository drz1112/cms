    ...
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ Request::routeIs('kategorimenu.*') || Request::routeIs('settingswebsite.*') || Request::routeIs('settingsfront.*') ? 'active' : ''}}">
                ...
                <ul id="menudrop2" class="sidebar-dropdown list-unstyled collapse {{ Request::routeIs('kategorimenu.*') || Request::routeIs('settingswebsite.*') || Request::routeIs('settingsfront.*') ? 'show' : ''}}" data-bs-parent="#sidebar"
                    style="">
