    ...
    <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand" href="{{route('backhome.index')}}">
            <span class="align-middle">
                <img src="{{asset('/'.$post_website->site_Image_dashboard)}}" alt="" style="max-width: 80%; min-width: 60%;">
            </span>
        </a>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ Request::routeIs('kategorimenu.*') || Request::routeIs('settingswebsite.*') ? 'active' : ''}}">
                ...
                <ul id="menudrop2" class="sidebar-dropdown list-unstyled collapse {{ Request::routeIs('kategorimenu.*') || Request::routeIs('settingswebsite.*') || Request::routeIs('settingsfront.*') || Request::routeIs('settingsbannerfront.*') ? 'show' : ''}}" data-bs-parent="#sidebar"
                    style="">
